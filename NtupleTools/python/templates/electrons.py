...
id = PSet(
    ...
    objectGenPx     = '? (getDaughterGenParticle({object_idx}, 11, 0).isAvailable && getDaughterGenParticle({object_idx}, 11, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 11, 0).px() : -999',
    objectGenPy     = '? (getDaughterGenParticle({object_idx}, 11, 0).isAvailable && getDaughterGenParticle({object_idx}, 11, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 11, 0).py() : -999',
    objectGenPz     = '? (getDaughterGenParticle({object_idx}, 11, 0).isAvailable && getDaughterGenParticle({object_idx}, 11, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 11, 0).pz() : -999',
...
trigger = PSet(
    ...
    objectMatchesSingleE27WP80 = r'matchToHLTPath({object_idx}, "HLT_Ele27_WP80_v\\d+")',
    ...
    #objectMatchesSingleE27WP80    = r'matchToHLTPath({object_idx}, "HLT_Ele27_WP80_v\\d+")',
    objectMatchesSingleE27Calo    = r'matchToHLTPath({object_idx}, "HLT_Ele27_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v\\d+")',
    objectMatchesSingleE32Calo    = r'matchToHLTPath({object_idx}, "HLT_Ele32_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_v\\d+")',
